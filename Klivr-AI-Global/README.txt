...
KLIVR AI GLOBAL VERSION
-----------------------
This build is the international USD version.
It uses the same production n8n webhook as the Philippine website.
The hidden contact-form source is: Klivr AI Global Website
This lets both websites share one n8n workflow and Google Sheets CRM while preserving lead attribution.
